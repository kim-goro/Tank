...
namespace Complete
{
	public class CameraControl : MonoBehaviour
	{
		...
		[SerializeField] float m_MinSize = 6.5f;                  // The smallest orthographic size the camera can be.
		Transform[] m_Targets; // All the targets the camera needs to encompass.
		...
		public static void SetTankPlayerToFollow(Transform[] targetTanks)
		{
			instance.m_Targets = targetTanks;
		}
