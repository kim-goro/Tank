...
{
	// 1) PDL(Exam).XML을 파싱해서 패킷의 포멧
	// 2) 자동화할 코드를 알맞게 채워줄거임
	//  - {}의 빈 부분을 채워서 적절한 코드를 생성해줌
	//  - managerFormat() => 'ClientPacketManager', 'ServerPacketManger'를 자동작성해줌
	//  - fileFormat, packetFormat... => '서버의 GenPackets', '클라의 GenPackets'를 자동작성해줌
